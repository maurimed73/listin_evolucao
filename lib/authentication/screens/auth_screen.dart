...
class _AuthScreenState extends State<AuthScreen> {
  ...
  _esqueciMinhaSenhaClicado() {
    ...
    showDialog(
        context: context,
        builder: (context) {
          TextEditingController redifinicaoSenhaController =
              TextEditingController(text: email);
          return AlertDialog(
            title: const Text('Confirme o e-mail para definição'),
            content: TextFormField(
              controller: redifinicaoSenhaController,
              decoration: const InputDecoration(label: Text('Confirme E-mail')),
            ),
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    authService
                        .redefinicaoSenha(
                            email: redifinicaoSenhaController.text)
                        .then((String? erro) {
                      if (erro == null) {
                        showSnackBar(
                          context: context,
